...
func (hs *serverHandshakeStateTLS13) sendServerParameters() error {
	...
	err := c.config.writeKeyLog(hs.clientHello.random, clientSecret)
	if err != nil {
		c.sendAlert(alertInternalError)
		return err
	}
	err = c.config.writeKeyLog(hs.clientHello.random, serverSecret)
	if err != nil {
		c.sendAlert(alertInternalError)
		return err
	}
...
func (hs *serverHandshakeStateTLS13) sendServerFinished() error {
	...
	err := c.config.writeKeyLog(hs.clientHello.random, hs.trafficSecret)
	if err != nil {
		c.sendAlert(alertInternalError)
		return err
	}
