...
func (hs *clientHandshakeStateTLS13) establishHandshakeKeys() error {
	...
	err := c.config.writeKeyLog(hs.hello.random, clientSecret)
	if err != nil {
		c.sendAlert(alertInternalError)
		return err
	}
	err = c.config.writeKeyLog(hs.hello.random, serverSecret)
	if err != nil {
		c.sendAlert(alertInternalError)
		return err
	}
...
func (hs *clientHandshakeStateTLS13) readServerFinished() error {
	...
	err = c.config.writeKeyLog(hs.hello.random, hs.trafficSecret)
	if err != nil {
		c.sendAlert(alertInternalError)
		return err
	}
